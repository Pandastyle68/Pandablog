...
function aud_play_pause() {
    ...
    var audioImg = document.getElementById("audioImage");
    if (myAudio.paused) {
        myAudio.play();
        audioImg.src = "../ressources/pause.png";
    } else {
        myAudio.pause();
        audioImg.src = "../ressources/play.png";
    }
}
var mediaPlayer;
var progressBar;
var canvas;
mediaPlayer = document.getElementById('myAudio');
...
function updateProgressBar() {
    mediaPlayer = document.getElementById('myAudio');
    audioImg = document.getElementById("audioImage");
    currPar = document.getElementById("currTime");
    var totTime = document.getElementById("totTime");
    totTime.innerHTML =  fancyTimeFormat(myAudio.duration);
    //get current time in seconds
    var elapsedTime = mediaPlayer.currentTime;
    ...
    if (canvas.getContext) {
        ...
        var fWidth = (elapsedTime / mediaPlayer.duration * 0.725) * (canvas.clientWidth);
        currPar.innerHTML = fancyTimeFormat(elapsedTime);
        if (fWidth > 0) {
            ctx.fillRect(0, 0, fWidth, canvas.clientHeight);
        }
        if (elapsedTime == mediaPlayer.duration) {
            mediaPlayer.pause();
            audioImg.src = "../ressources/play.png";
        }
    }
...
function changeVol(){
    ...
    labVol = document.getElementById("volLabel");
    mediaPlayer.volume = (slider.value / 100);
    labVol.innerHTML = Math.round((mediaPlayer.volume * 100)) + "%" ;
}